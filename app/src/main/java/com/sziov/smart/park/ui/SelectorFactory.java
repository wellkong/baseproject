package com.sziov.smart.park.ui;
...
/**
 * https://www.jianshu.com/p/7fb9567a5869
 */
    ...
    public static final class ShapeSelector {
        ...
        public StateListDrawable create() {
            ...
            if (hasSetDisabledBgColor || hasSetDisabledStrokeColor) {
                GradientDrawable disabledShape = getItemShape(mShape, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mCornerRadius),
                        mDisabledBgColor, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mStrokeWidth), mDisabledStrokeColor);
                selector.addState(new int[]{-android.R.attr.state_enabled}, disabledShape);
            }

            //pressed = true
            if (hasSetPressedBgColor || hasSetPressedStrokeColor) {
                GradientDrawable pressedShape = getItemShape(mShape, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mCornerRadius),
                        mPressedBgColor, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mStrokeWidth), mPressedStrokeColor);
                selector.addState(new int[]{android.R.attr.state_pressed}, pressedShape);
            }

            //selected = true
            if (hasSetSelectedBgColor || hasSetSelectedStrokeColor) {
                GradientDrawable selectedShape = getItemShape(mShape, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mCornerRadius),
                        mSelectedBgColor, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mStrokeWidth), mSelectedStrokeColor);
                selector.addState(new int[]{android.R.attr.state_selected}, selectedShape);
            }

            //focused = true
            if (hasSetFocusedBgColor || hasSetFocusedStrokeColor) {
                GradientDrawable focusedShape = getItemShape(mShape, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mCornerRadius),
                        mFocusedBgColor, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mStrokeWidth), mFocusedStrokeColor);
                selector.addState(new int[]{android.R.attr.state_focused}, focusedShape);
            }

            //default
            GradientDrawable defaultShape = getItemShape(mShape, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mCornerRadius),
                    mDefaultBgColor, DensityUtil.dip2px(AppConfigEntrance.getApplicationContext(), mStrokeWidth), mDefaultStrokeColor);
