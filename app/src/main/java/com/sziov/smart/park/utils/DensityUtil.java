...
public class DensityUtil {
    ...
    public static int getScreenWidth(){
        final Resources resources = AppConfigEntrance.getApplicationContext().getResources();
    ...
    public static void getDpi(Activity activity){
        ...
        Log.e("screenWidth", "screenWidth=" + screenWidth + "; screenHeight=" + screenHeight);
    }
}
