...
/**
 * @ProjectName: FingerIdCard
 * @Package: com.willkong.core.crash
 * @ClassName: CrashAppLog
 * @Author: willkong
 * @Description: 异常捕获保存本地
 * @CreateDate: 2020/7/24 23:32
 */
public class CrashAppLog implements UncaughtExceptionHandler {
     ...
     * 这个类是系统默认异常类
     */
    private UncaughtExceptionHandler mUncaught = null;
    ...
    private void collectDeviceInfo(Context context) {
        try {
             ...
             * 获取手机型号，系统版本，以及SDK版本
             */
            logInfos.put("手机型号:", Build.MODEL);
            logInfos.put("系统版本", "" + Build.VERSION.SDK);
            logInfos.put("Android版本", Build.VERSION.RELEASE);
