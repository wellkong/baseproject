...
import com.sziov.smart.park.net.callback.RequestCallback;
import com.sziov.smart.park.net.download.DownloadHandler;
...
public class RestClient {
    ...
    public final void download() {
        new DownloadHandler(URL, REQUEST, DOWNLOAD_DIR, EXTENSION, NAME, SUCCESS, FAILURE, ERROR, PROGRESS).handleDownload();
    }
}
